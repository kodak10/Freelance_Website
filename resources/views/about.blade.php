                      ...
                      <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                        <div class="accordion-body">
                          L’appellation EL BARA est une expression hébraïque composée de EL qui renvoie à la puissance, la force et de BARA qui signifie la création, l’invention, l’innovation, l’imagination etc.… Outre ces sémantiques hébraïques, EL BARA trouve son sens en langue Malinké (un groupe ethnique ivoirien) et dans le jargon ivoirien à travers le travail surtout le travail bien fait. 
                            ...
                            En resumé E-BAG est une plateforme autour de laquelle gravitent <strong>Offres et Demandes</strong>. <br>
            ...
            <div class="position-relative wow fadeInLeft" data-wow-delay="300ms">
              ...
              <div class="list-style2">
                <ul class="mb20">
                  ...
                  </span>Connectez-vous à des entreprises ayant une expérience commerciale approuvée.
                  </li>
                  <li><span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  </span>Entrer en contact avec les meilleurs entreprises pour votre service.
                  </li>
                  <li><span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="17" viewBox="0 0 16 17" fill="none">
                      <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  </span>Accompagnement personnalisé.
                  </li>
        ...
        <div class="row wow fadeInDown" data-wow-delay="400ms">
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="iconbox-style9 default-box-shadow1 bgc-white p40 bdrs12 position-relative mb30">
              ...
              <p class="text mb-0">Veuillez compléter le formulaire en renseignant vos besoins, et l'entreprise vous contactera pour en discuter.</p>
            </div>
          </div>
